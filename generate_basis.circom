// To generate basis points - powers of 32 and 1-8 co-efficients to be used as per the hashing algorithm

pragma circom 2.0.0;

include "./utils/montgomery.circom";

// We will use 3 generators where each generator cover 200 bits - we need to create a 512 bit hash.
template generate_basis() {
    ...
    // within each round, we need to double the input 5 times.
    component base2[50];
    component base4[50];
    component base8[50];
    component base16[50];
    ...
    for(var i7=0; i7 < 50; i7++) {
        ...
        adders7[i7].in2[0] <== basis5[i7][0];
        adders7[i7].in2[1] <== basis5[i7][1];
